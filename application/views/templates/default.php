    ...
    <div class="container-fluid">
      <div id="mySidenav" class="sidenav" >
       <a id="menu-button" onclick="openNav()" style="cursor:pointer"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
        ...
        <a href="<?php echo base_url('user/settings/'. $this->session->userdata('is_active')) ?>"><i class="fa fa-cogs" aria-hidden="true"></i><span class="menu-text pull-right" style="display:none">Settings</span></a>
